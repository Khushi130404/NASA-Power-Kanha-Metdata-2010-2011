...
# 2. Paths (EDIT HERE)
# -----------------------------
input_csv <- "D:/NASA_Power_Kanha_Metdata_2010_2011/Data_Table/data_meteorology/se_kanha_ndvi_meteorology.csv"
plot_dir  <- "D:/NASA_Power_Kanha_Metdata_2010_2011/Plots/se_kanha_plots"
